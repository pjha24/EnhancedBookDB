...
Book.create(name: "Harry Potter", genre: "Fiction", author_id: 1, user_id: 1 )
Book.create(name: "Harry Potter", genre: "Fiction", author_id: 1, user_id: 2)
Book.create(name: "IT", genre: "horror", author_id: 2, user_id: 1)
Book.create(name: "Hamlet", genre: "tragedy", author_id: 3, user_id: 2)
Book.create(name: "Macbeth", genre: "tragedy", author_id: 3, user_id: 1)
Book.create(name: "1984", genre: "distopian fiction", author_id: 4, user_id: 1 )
Book.create(name: "Pride and Prejudice", genre: "romance", author_id: 5, user_id:2 )